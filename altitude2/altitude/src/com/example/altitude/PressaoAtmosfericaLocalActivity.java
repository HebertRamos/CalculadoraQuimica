...
public class PressaoAtmosfericaLocalActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textAltitude = (TextView) findViewById(R.id.Altitude);
		textPrecissao = (TextView) findViewById(R.id.Precissao);
		textPressaoMilibar = (TextView) findViewById(R.id.PressaoMilibar);
		textPressaoAtm = (TextView) findViewById(R.id.PressaoAtm);
	...
	private void updateLoc(Location loc) {
		...
		textAltitude.setText("Altitude: " + loc.getAltitude());
		textPrecissao.setText("Precissao: " + loc.getAccuracy());
		textPressaoAtm.setText("Pressao (atm): " + pressaoAtm);
		textPressaoMilibar.setText("Pressao (milibar): " + pressaoMilibar);
	}
